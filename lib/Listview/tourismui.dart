      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: 310,
              left: 20,
              child: Text("Italy",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 25,  ),)),
          Positioned(
            top: 350,
            left: 10,
            right: 10,
          ...
          Positioned(
            bottom: 120,
              left: 20,
              child: Text("Place to Visit",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 25,))),
          Positioned(
            bottom: 50,
            left: 30,
            child: Container(
